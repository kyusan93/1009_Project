...
void newStaffRecord()
{
  ...
  staffObj->write_data(
      "person.dat", staffObj->getName(), staffObj->getDateOfBirth(),
      staffObj->getGender(), staffObj->getContactNumber(),
      staffObj->getEmail(), staffObj->getDesignation(), staffObj->getDepartment(), staffObj->getSalary());
}
